...
`<vox-alert>` is a page-level notification, optionally dismissible. For static advisory text within prose, use [Callout](../callout/). Shows an icon matching `variant` automatically — no icon slot to fill in.
