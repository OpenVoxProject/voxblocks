...
hero:
  name: VoxBlocks
  text: Web components for the Vox Pupuli community
  tagline: Framework-agnostic building blocks in the style of the OpenVox docs — drop them into any site, from plain HTML to Vue.
  actions:
    - theme: brand
      text: Get Started
